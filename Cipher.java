...
public class Cipher {
    ...
    public static String[] getKey(String fileName) {
        ...
        try {
            File myFile = new File(fileName.toLowerCase().trim());
            Scanner scnr = new Scanner(myFile);
            String cipherRaw = scnr.nextLine();
            String cipher = cipherRaw.substring(cipherRaw.indexOf(":") + 1);
            String plainRaw = scnr.nextLine();
            String plain = plainRaw.substring(plainRaw.indexOf(":") + 1);
            String[] key = new String[2];
            key[PLAIN_INDEX] = plain;
            key[CIPHER_INDEX] = cipher;
            return key;
    ...
    public static int checkKey(String[] key) {
        ...
        for (int i = 0; i < key[PLAIN_INDEX].length() - 1; i++) {
        ...
        for (int i = 0; i < key[CIPHER_INDEX].length() - 1; i++) {
