...
public class Ages {
    ...
    public static void main(String[] args) {
        ...
        double average = getAverageAge(johnAge, mattAge, sarahAge, emilyAge);
        ...
        average  = getAverageAge(johnAge, mattAge, sarahAge, emilyAge);
        System.out.println("The new average age is " + average);
    }
